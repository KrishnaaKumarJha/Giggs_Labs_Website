...
import { Building2, ShieldAlert, CreditCard, FileCheck, Database, Lock, CheckCircle2 } from 'lucide-react';

/* ── DATA ── */
const subPages = [
    { title: 'Digital Banking Platforms', desc: 'Enable modern, frictionless, and secure banking experiences.', icon: Building2, capabilities: ['mobile banking platforms', 'digital onboarding', 'secure customer identity systems'] },
    { title: 'Fraud Detection & Risk Analytics', desc: 'Proactive defense with machine learning models and real-time monitoring.', icon: ShieldAlert, capabilities: ['AI fraud detection models', 'anomaly detection', 'real-time risk scoring'] },
    { title: 'Payment Infrastructure Engineering', desc: 'Building scalable, high-volume payment systems and gateways.', icon: CreditCard, capabilities: ['payment gateway performance engineering', 'high-volume transaction processing', 'payment security'] },
    { title: 'Regulatory & Compliance Automation', desc: 'Streamlining compliance workflows reducing manual oversight.', icon: FileCheck, capabilities: ['AML monitoring', 'KYC automation', 'regulatory reporting automation'] },
    { title: 'Financial Data Platforms', desc: 'Modernizing financial data architecture to fuel real-time intelligence.', icon: Database, capabilities: ['real-time financial analytics', 'trading data platforms', 'enterprise financial data lakes'] },
    { title: 'Cybersecurity for Financial Systems', desc: 'Hardening financial operations against sophisticated cyber threats.', icon: Lock, capabilities: ['fraud monitoring', 'zero-trust security', 'AI threat detection'] }
];
...
const stats = [
    ...
    },
    {
        ...
        "sub": "Real-time transactions"
    },
    {
        "value": "Compliant",
        "label": "Regulatory Adherence",
        "sub": "Built for strict standards"
    }
];
const techStack = ['Kafka', 'Kubernetes', 'AWS Fargate', 'Plaid API', 'Stripe Connect', 'Elasticsearch', 'PostgreSQL', 'Redis', 'TensorFlow', 'Apache Flink', 'Zero Trust IAM', 'Docker'];
const allUseCases = [
    {
        "title": "Neobank Infrastructure",
        "desc": "Secure, cloud-native architecture powering the next generation of digital-first banks."
    },
    {
        "title": "Digital Wallet Platforms",
        "desc": "High-performance payment ecosystems enabling seamless peer-to-peer and merchant transactions."
    },
    {
        "title": "Payment Fraud Detection",
        "desc": "AI-driven anomaly detection models stopping fraudulent transactions in milliseconds."
    },
    {
        "title": "Credit Card Fraud Analytics",
        "desc": "Real-time behavioral scoring to protect cardholder data and prevent unauthorized usage."
    },
    {
        "title": "Real-time Payments",
        "desc": "Ultra-low latency payment rails integration for instantaneous domestic and cross-border settlement."
    },
    {
        "title": "Compliance Analytics",
        "desc": "Automated KYC/AML monitoring and advanced regulatory reporting dashboards."
    }
];
...
export default function IndustryPage() {
    return (
        <PageShell eyebrow="Industries" title="FinTech Solutions" description="Giggs Software Labs helps financial institutions build secure, intelligent, and high-performance digital platforms powered by AI, advanced analytics, and automation." videoSrc="/hero/solutions.mp4" videoOpacity={0.6} align="center">
            <Head><title>FinTech Solutions | Giggs Software Labs</title></Head>
            ...
            <div className="flex flex-col items-center mt-6 mb-20 gap-8">
                <div className="flex flex-wrap justify-center gap-3 text-sm font-medium text-slate-400">
                    <span className="flex items-center gap-2 rounded-full border border-sky-500/20 bg-sky-500/5 px-4 py-2 text-sky-300 backdrop-blur-sm"><span className="h-2 w-2 rounded-full bg-sky-400 animate-pulse" /> fraud and cyber threats</span>
<span className="flex items-center gap-2 rounded-full border border-blue-500/20 bg-blue-500/5 px-4 py-2 text-blue-300 backdrop-blur-sm"><span className="h-2 w-2 rounded-full bg-blue-400 animate-pulse" /> real-time transaction processing</span>
<span className="flex items-center gap-2 rounded-full border border-cyan-500/20 bg-cyan-500/5 px-4 py-2 text-cyan-300 backdrop-blur-sm"><span className="h-2 w-2 rounded-full bg-cyan-400 animate-pulse" /> regulatory compliance</span>
<span className="flex items-center gap-2 rounded-full border border-indigo-500/20 bg-indigo-500/5 px-4 py-2 text-indigo-300 backdrop-blur-sm"><span className="h-2 w-2 rounded-full bg-indigo-400 animate-pulse" /> digital banking innovation</span>
<span className="flex items-center gap-2 rounded-full border border-sky-500/20 bg-sky-500/5 px-4 py-2 text-sky-300 backdrop-blur-sm"><span className="h-2 w-2 rounded-full bg-sky-400 animate-pulse" /> scalable financial platforms</span>
                ...
                <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="relative overflow-hidden rounded-[4rem] border border-[#1E7BFF]/20 bg-[#0B1F3B]/40 p-16 md:p-24 text-center shadow-[0_0_100px_rgba(30,123,255,0.05)]">
                    ...
                    <div className="relative z-10">
                        ...
                        <p className="mt-6 text-lg md:text-xl text-slate-300 max-w-2xl mx-auto font-medium leading-relaxed mb-12">
                            Partner with Giggs Software Labs to build scalable, secure, and compliant financial solutions.
                        </p>
