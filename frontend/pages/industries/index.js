                ...
                <section className="relative mx-auto max-w-7xl px-4 pt-4 pb-16 md:pt-8 md:pb-24 md:px-6">
                    <div className="max-w-3xl text-center mx-auto mb-16">
                        ...
                        <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold tracking-tight text-white futuristic mb-6">
                            Industries We <span className="text-transparent bg-clip-text bg-gradient-to-r from-sky-300 to-blue-400">Serve</span>
                        </h1>
                        <p className="text-base sm:text-lg text-slate-300 leading-relaxed max-w-2xl mx-auto">
                            Deep domain expertise paired with intelligent engineering. We bring tailored transformation to every sector we partner with.
                        </p>
                    </div>
