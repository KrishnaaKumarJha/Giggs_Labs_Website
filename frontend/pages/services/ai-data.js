...
const capabilities = [
    { name: 'Generative AI & LLM Applications', detail: 'Custom LLMs, fine-tuned models, RAG pipelines, and prompt engineering for production-grade AI applications. We build chatbots, copilots, document processors, and content engines powered by state-of-the-art foundation models.' },
    ...
    { name: 'NLP & Conversational AI', detail: 'Sentiment analysis, entity extraction, text classification, summarization, and intelligent chatbots. Multilingual support with production-grade accuracy and latency.' },
