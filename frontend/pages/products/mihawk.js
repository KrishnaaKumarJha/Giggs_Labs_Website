...
function FeatureCard({ feature, index }) {
    ...
    return (
        <motion.article
            ...
            className="group relative overflow-hidden rounded-[2rem] border border-slate-800/60 bg-slate-950/40 p-1 backdrop-blur-md transition-all duration-500 hover:border-orange-500/50 hover:shadow-[0_0_30px_rgba(249,115,22,0.15)]"
        >
            <div className="pointer-events-none absolute inset-0 bg-gradient-to-br from-orange-500/5 via-transparent to-amber-500/5 opacity-0 transition group-hover:opacity-100" />
                    ...
                    <div className="flex-1">
                        <div className="flex items-center gap-3 mb-2">
                            ...
                            <div className="ml-auto md:ml-2">
                                <span className="h-1.5 w-1.5 rounded-full bg-orange-500 shadow-[0_0_8px_#f97316] animate-pulse" />
                            </div>
                        </div>
                        <p className="text-sm text-slate-300 leading-relaxed font-medium">{feature.desc}</p>
                    </div>
                    <motion.div
                        animate={{ rotate: isOpen ? 180 : 0 }}
                        transition={{ duration: 0.3 }}
                        className="flex-shrink-0 mt-1 text-slate-400 group-hover:text-orange-400 transition-colors"
                    >
        ...
        <PageShell fluid={true}>
            ...
            <section className="relative -mt-20 w-full overflow-hidden min-h-[75vh] flex items-center justify-center">
                ...
                <div
                    ...
                    style={{
                        background:
                            'linear-gradient(90deg, rgba(2,6,23,0.9) 0%, rgba(2,6,23,0.8) 35%, rgba(2,6,23,0.4) 55%, rgba(2,6,23,0) 100%)',
                    }}
                />

                {/* Soft glows - changed from orange to neutral slate/sky to remove orange accent */}
                <div className="pointer-events-none absolute right-[-10%] top-[-25%] z-10 h-56 w-56 rounded-full bg-slate-500/10 blur-3xl" />
                <div className="pointer-events-none absolute left-[-8%] bottom-[-20%] z-10 h-56 w-56 rounded-full bg-sky-600/10 blur-3xl" />

                <div className="relative z-20 w-full">
                    <div className="mx-auto max-w-6xl px-4 py-16 md:px-6">
                        <motion.div initial="hidden" animate="show" variants={{ show: { transition: { staggerChildren: 0.12 } } }}>

                            {/* Mihawk Logo (Acting as Header) */}
                            ...
                            <motion.div variants={fadeUp} className="inline-flex items-center gap-2 rounded-full border border-slate-800 bg-slate-950/50 px-3 py-1 text-[10px] md:text-xs font-bold uppercase tracking-widest text-slate-400 mb-6 font-mono">
                                <span className="h-1.5 w-1.5 rounded-full bg-sky-400 shadow-[0_0_8px_#38bdf8] animate-pulse" />
                                Flagship Security Platform
                            </motion.div>

                            <motion.h1 variants={fadeUp} className="text-3xl sm:text-5xl lg:text-7xl font-black tracking-tighter text-slate-50 uppercase leading-[0.95]">
                                Secure the <br />
                                <span className="bg-gradient-to-r from-orange-400 to-amber-500 bg-clip-text text-transparent italic">Unseen.</span>
                            </motion.h1>
                            ...
                            <motion.div variants={fadeUp} className="mt-10 flex flex-wrap gap-4">
                                <a
                                    ...
                                    target="_blank"
                                    rel="noreferrer"
                                    className="inline-flex items-center justify-center rounded-full bg-gradient-to-r from-orange-600 to-amber-600 px-8 py-3.5 text-sm font-bold text-white shadow-[0_0_25px_rgba(249,115,22,0.4)] hover:scale-105 transition-all duration-300"
                                >
                                    Visit Mihawk Platform →
                                </a>
                                <Link
                                    href="/contact"
                                    className="inline-flex items-center justify-center rounded-full border border-orange-500/40 bg-orange-500/5 px-8 py-3.5 text-sm font-bold text-orange-200 hover:bg-orange-500/15 transition-all duration-300"
                                >
                                    Request a demo
                                </Link>
                            </motion.div>
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    {stats.map((stat, i) => (
                        <motion.div
                            ...
                            className="rounded-3xl border border-slate-800/80 bg-slate-950/40 p-6 text-center backdrop-blur-sm shadow-xl hover:border-orange-500/30 transition-colors"
                        >
                            <div className="text-2xl md:text-3xl font-black bg-gradient-to-r from-orange-400 to-amber-400 bg-clip-text text-transparent">
                                {stat.value}
                            </div>
            ...
            <section className="relative z-10 mx-auto max-w-6xl px-4 md:px-6 mb-24">
                <div className="mb-12">
                    <div className="text-[11px] font-black uppercase tracking-[0.3em] text-orange-400">Security Ecosystem</div>
                    <h2 className="mt-2 text-3xl md:text-4xl font-extrabold tracking-tight text-slate-50 uppercase">
                        Enterprise security, <span className="text-amber-500">fully managed</span>
                    </h2>
                    <div className="mt-4 h-1 w-24 rounded-full bg-gradient-to-r from-orange-500 to-amber-500" />
                </div>
            ...
            <section className="relative z-10 mx-auto max-w-6xl px-4 md:px-6 mb-24">
                <motion.div
                    ...
                    className="rounded-[3rem] border border-slate-800/60 bg-slate-950/40 p-8 md:p-12 backdrop-blur-md shadow-2xl"
                >
                    <div className="text-[10px] font-black uppercase tracking-[0.4em] text-orange-400 mb-6">Security Stack</div>
                    <h3 className="text-2xl font-bold text-slate-50 mb-8 tracking-tight">Advanced Defense Technologies</h3>
                    <div className="flex flex-wrap gap-3">
                        {techStack.map((tech) => (
                            <span
                                key={tech}
                                className="rounded-full border border-slate-700/60 bg-slate-900/60 px-5 py-2.5 text-xs font-bold text-slate-200 hover:border-orange-500/50 hover:text-white transition-all duration-300"
                            >
                                {tech}
                            </span>
                        ))}
            ...
            <section className="relative z-10 mx-auto max-w-6xl px-4 md:px-6 mb-24">
                <div className="mb-12">
                    <div className="text-[11px] font-black uppercase tracking-[0.3em] text-orange-400">Industry Verticals</div>
                    <h2 className="mt-2 text-3xl md:text-4xl font-extrabold tracking-tight text-slate-50 uppercase">
                        Built for <span className="text-orange-400">Scale</span>
                    </h2>
                </div>
                ...
                <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
                    {useCases.map((uc, i) => (
                        <motion.div
                            ...
                            className="group relative rounded-3xl border border-slate-800/80 bg-slate-950/40 p-7 hover:border-orange-500/40 transition-all duration-500"
                        >
                            <div className="absolute top-0 right-0 p-4 opacity-10 group-hover:opacity-30 transition-opacity">
                                <svg className="h-12 w-12 text-orange-400" fill="currentColor" viewBox="0 0 24 24">
                                    <path d="M12 2L2 7l10 5 10-5-10-5zM2 17l10 5 10-5M2 12l10 5 10-5" />
                                </svg>
                            </div>
                            <h4 className="text-base font-black uppercase tracking-tight text-slate-100 mb-3 group-hover:text-orange-400 transition-colors">{uc.title}</h4>
            ...
            <section className="relative z-10 mx-auto max-w-6xl px-4 md:px-6 pb-40">
                <motion.div
                    ...
                    viewport={{ once: true }}
                    transition={{ duration: 0.6 }}
                    className="relative overflow-hidden rounded-[3rem] border border-slate-800 bg-slate-950/40 p-12 md:p-16 text-center backdrop-blur-3xl shadow-[0_0_80px_rgba(249,115,22,0.1)]"
                >
                    <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_center,_rgba(249,115,22,0.1),_transparent_70%)]" />
                    <div className="relative z-10">
                        <h2 className="text-3xl md:text-5xl font-black tracking-tighter text-slate-50 uppercase mb-6">
                            Deployment in <span className="text-amber-400">48 Hours</span>
                        </h2>
                        ...
                        <div className="flex flex-wrap justify-center gap-5">
                            <a
                                ...
                                target="_blank"
                                rel="noreferrer"
                                className="inline-flex items-center justify-center rounded-full bg-gradient-to-r from-orange-500 to-amber-600 px-10 py-4 text-sm font-black uppercase tracking-widest text-white shadow-[0_0_30px_rgba(249,115,22,0.5)] hover:scale-105 transition-all duration-300"
                            >
                                Go To Mihawk Platform →
                            </a>
                            <Link
                                href="/contact"
                                className="inline-flex items-center justify-center rounded-full border border-orange-500/50 bg-orange-500/5 px-10 py-4 text-sm font-black uppercase tracking-widest text-orange-200 hover:bg-orange-500/20 transition-all duration-300"
                            >
