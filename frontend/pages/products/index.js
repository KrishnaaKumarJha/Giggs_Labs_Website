                ...
                <div className="container relative z-10 mx-auto px-4 max-w-6xl">
                    <div className="grid md:grid-cols-2 gap-20 items-center">
                        <div>
                            ...
                            <h2 className="text-4xl md:text-6xl font-black text-slate-50 tracking-tighter uppercase leading-[0.95] mb-8">
            ...
            <section className="pb-32 px-4" style={{ overflow: 'visible' }}>
                ...
                >
                    ...
                    <div className="relative z-10 px-8 py-20 md:px-24 md:py-32" style={{ overflow: 'visible' }}>
                        <h2 className="text-4xl md:text-7xl font-black tracking-tighter text-slate-50 uppercase mb-8" style={{ lineHeight: '1.3', overflow: 'visible', paddingTop: '0.15em', textShadow: '0 0 1px rgba(255,255,255,0.5)' }}>
                            Ready to <br />
                            <span className="italic text-sky-400" style={{ textShadow: '0 0 1px rgba(56,189,248,0.5)' }}>Power Up?</span>
                        </h2>
