  ...
  return (
    <PageShell>
      ...
      <section className="relative -mt-20 flex min-h-[70vh] items-center justify-center overflow-hidden">
        ...
        <div className="absolute inset-0 z-0 text-sky-500">
        ...
        <div className="container relative z-10 mx-auto px-4 text-center">
          ...
          >
            ...
            <h1 className="text-4xl md:text-6xl font-black tracking-tighter text-slate-50">
              Services for teams that <span className="bg-gradient-to-r from-cyan-400 to-blue-500 bg-clip-text text-transparent italic">care about quality.</span>
            </h1>
                ...
                >
                  ...
                  <div className="relative">
                    <div className="flex items-center gap-4 mb-6">
                      <div className="flex h-14 w-14 items-center justify-center rounded-2xl border border-slate-800 bg-slate-950/50 text-3xl group-hover:scale-110 transition-transform duration-500">
                        {area.icon}
                      </div>
          ...
          {coreServices.map((svc, i) => (
            ...
            >
              <div className="relative z-10 flex gap-6">
                <div className="flex-shrink-0 flex h-16 w-16 items-center justify-center rounded-2xl bg-slate-900 border border-slate-800 text-3xl transition-transform duration-500 group-hover:scale-110">
                  {svc.icon}
                </div>
                <div>
        ...
        <div className="grid gap-4 md:grid-cols-4">
          {processSteps.map((p, i) => (
            ...
            >
              ...
              <h3 className="mt-4 text-base font-black text-slate-50 tracking-tight">{p.title}</h3>
      ...
      <section className="mb-32 py-12">
        ...
        <div className="grid gap-6 md:grid-cols-3">
          {engagementModels.map((model, i) => (
            ...
            >
              <div className="mb-6 flex h-14 w-14 items-center justify-center rounded-2xl bg-slate-950 border border-slate-800 text-3xl group-hover:scale-110 transition-transform">
                {model.icon}
              </div>
        ...
        >
          ...
          <div className="relative z-10 space-y-8">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              ...
              <Link href="/projects" className="inline-flex items-center justify-center rounded-full border border-slate-700 bg-slate-950/60 px-10 py-4 text-sm font-black uppercase tracking-widest text-slate-50 hover:bg-slate-900 transition-all">
                View case studies
              </Link>
            </div>
          </div>
