        ...
        const ChatbotLogic = (function () {
            ...
            const DEFAULT_CONFIG = {
                ...
                routes: {
                    ...
                    projects: { url: "/projects", label: "View Projects", icon: "🚀" },
                ...
                knowledge: [
                    ...
                    {
                        keywords: ["project", "projects", "work", "portfolio", "clients", "case studies", "what have you built", "examples", "track record", "past work", "experience"],
                        responses: [
                            "We've delivered high-impact solutions globally, from fintech platforms to AI-driven security systems. Take a look at our featured projects to see our engineering in action!",
                        ],
                        action: "projects"
                    },
                    {
                ...
                fallbacks: [
                    "Hmm, I'm not quite sure about that. Can you rephrase? I can help with services, cybersecurity (Mihawk), and projects.",
